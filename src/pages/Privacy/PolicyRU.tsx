  ...
  return (
    <>
      ...
      <div>
        ...
        <span>Гаврилиным И.В.</span> (далее&nbsp;— Оператор).
      </div>
      <ol>
        <li>Защита персональных данных является приоритетом для Оператора.</li>
        <li>
          ...
          <span>https://gavrilin.online</span>.
        </li>
      </ol>
      ...
      <ol>
        ...
        <li>
          ...
          по&nbsp;сетевому адресу <span>https://gavrilin.online</span>.
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              информацию в&nbsp;течение 10&nbsp;дней с&nbsp;даты получения
              такого запроса;
            </li>
            <li>
              публиковать или иным образом обеспечивать неограниченный доступ
              к&nbsp;настоящей Политике в&nbsp;отношении обработки персональных
              данных;
            </li>
            <li>
      ...
      <ol>
        ...
        <li>
          ...
          заранее определенных и&nbsp;законных целей. Не&nbsp;допускается
      ...
      <ol>
        ...
        <li>
          ...
          круга лиц к&nbsp;которым предоставлен субъектом персональных данных
          либо по&nbsp;его просьбе (далее&nbsp;— общедоступные персональные
          данные).
        </li>
        <li>
      ...
      <ol>
        ...
        <li>
          ...
          связанных с&nbsp;исполнением действующего законодательства либо
        ...
        <li>
          ...
          Оператора <span>gavrilin.ivan.v@gmail.com</span> с&nbsp;пометкой
        ...
        <li>
          ...
          <span>gavrilin.ivan.v@gmail.com</span> с&nbsp;пометкой «Отзыв согласия
      ...
      <ol>
        ...
        <li>
          Оператор до&nbsp;подачи вышеуказанного уведомления, обязан получить
          от&nbsp;органов власти иностранного государства, иностранных
      ...
      <ol>
        <li>
          ...
          <span>gavrilin.ivan.v@gmail.com</span>.
        </li>
        <li>
        ...
        <li>
          ...
          <span>https://gavrilin.online/privacy</span>.
        </li>
      </ol>
    </>
  );
